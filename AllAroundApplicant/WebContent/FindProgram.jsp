  ...
  <div class="container">
    <form action="findprogram" method="post" class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10" style="padding-left : 0">
          <input type="text" class="form-control" id="schoolname" name="schoolname" placeholder="School Name" value="${fn:escapeXml(param.schoolname)}">
        </div>
      </div>
      <div class="form-group">
    ...
    <div style="height: 500px">
     <div class="panel panel-primary"  id="panel">
       <div class="panel-heading">Matching Programs: <span id="successMessage">${messages.success}</span></div>
