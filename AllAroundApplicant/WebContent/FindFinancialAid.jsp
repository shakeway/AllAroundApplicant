...
<body>
  ...
  <div class="container">
    <form action="findfinancialaid" method="post" class="form-horizontal">
      <h2>Search for Financial Aid Information by School Name</h2>
        ...
        <div class="panel-body">
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tr>
                <td><c:out value="${financialaid.getSchool().getName()}" /></td>
